...
tags:
  []
links:
  curseforge: "https://www.curseforge.com/minecraft/search?class=mc-mods&search=Glodium"
  modrinth: "https://modrinth.com/mods?q=Glodium"
draft: false
---
...
**Glodium** (`glodium`, v1.20-1.5) — Библиотека: зависимость для других модов, сама по себе почти не добавляет контента.
