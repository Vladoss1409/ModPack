...
name: "Placebo"
modId: "placebo"
version: "1.20.1-8.6.3.jar"
category: library
tags:
  []
links:
  curseforge: "https://www.curseforge.com/minecraft/search?class=mc-mods&search=Placebo"
  modrinth: "https://modrinth.com/mods?q=Placebo"
draft: false
---
...
**Placebo** (`placebo`, v1.20.1-8.6.3.jar) — Библиотека: зависимость для других модов, сама по себе почти не добавляет контента.
