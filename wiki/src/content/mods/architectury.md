...
name: "Architectury"
modId: "architectury"
version: "9.2.14-forge.jar"
category: library
tags:
  []
links:
  curseforge: "https://www.curseforge.com/minecraft/search?class=mc-mods&search=Architectury"
  modrinth: "https://modrinth.com/mods?q=Architectury"
draft: false
---
...
**Architectury** (`architectury`, v9.2.14-forge.jar) — Библиотека: зависимость для других модов, сама по себе почти не добавляет контента.
