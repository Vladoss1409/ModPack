...
tags:
  []
links:
  curseforge: "https://www.curseforge.com/minecraft/search?class=mc-mods&search=Aether"
  modrinth: "https://modrinth.com/mods?q=Aether"
draft: false
---
...
**Aether** (`aether`, v1.20.1-1.5.2) — Генерация мира: биомы, измерения и структуры.
