...
version: "4.12.0-all.jar"
category: library
tags:
  []
links:
  curseforge: "https://www.curseforge.com/minecraft/search?class=mc-mods&search=Kotlinforforge"
  modrinth: "https://modrinth.com/mods?q=Kotlinforforge"
draft: false
---
...
**Kotlinforforge** (`kotlinforforge`, v4.12.0-all.jar) — Библиотека: зависимость для других модов, сама по себе почти не добавляет контента.
